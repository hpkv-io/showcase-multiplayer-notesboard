/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 67bd1a982de7ef47477f08e227626943)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_HPKV_API_BASE_URL: string;
		HPKV_API_KEY: string;
		NEXT_PUBLIC_BASE_URL: string;
		NEXT_PUBLIC_TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		NEXT_PUBLIC_HPKV_RPS_LIMIT: string;
		NEXT_PUBLIC_THROTTLE_DEFAULT_DELAY_MS: string;
		ASSETS: Fetcher;
	}
}
